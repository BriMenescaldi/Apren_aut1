...
from clases_prediccion import DateEncoder, GetDummiesTransformer, FeatureScaler
...
if __name__ == "__main__":
    ...
    humidity9am = st.slider('Humidity9am', 13.0, 100.5, 55.0)
    humidity3pm = st.slider('Humidity3pm', 55.0, 120.0, 60.0)
